...
namespace Xim.Simulators.ServiceBus.Processing
{
    internal class LinkProcessor : ILinkProcessor
    {
        ...
        public LinkProcessor(ISecurityContext securityContext, IEntityLookup entityLookup, ILoggerProvider loggerProvider)
        {
            _securityContext = securityContext;
            _entityLookup = entityLookup;
            _logger = loggerProvider.CreateLogger(nameof(LinkProcessor));
        }
